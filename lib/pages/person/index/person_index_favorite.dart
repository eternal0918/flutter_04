...
///喜欢
class PersonIndexFavorite extends StatelessWidget {
  const PersonIndexFavorite({super.key});
            ...
            children: [
              Wrap(
                ...
                children: [
                  ...
                  const Text("我的喜欢", style: TextStyle(color: EternalColors.titleColor, fontWeight: FontWeight.bold, fontSize: 15)),
                ],
              ),
              InkWell(
                onTap: () {},
