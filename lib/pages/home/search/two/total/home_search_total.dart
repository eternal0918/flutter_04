...
import 'package:flutter_04/pages/home/search/two/total/home_search_sliver_grid.dart';

class HomeSearchTotal extends StatefulWidget {
  HomeSearchTotal({Key? key}) : super(key: key);

  @override
  _HomeSearchTotalState createState() => _HomeSearchTotalState();
}

class _HomeSearchTotalState extends State<HomeSearchTotal> {
  int _num = 10;
