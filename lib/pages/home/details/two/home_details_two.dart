...
class _HomeDetailsTwoState extends State<HomeDetailsTwo> {
  TextStyle titleStyle = const TextStyle(color: EternalColors.textColor, fontSize: 12);
  TextStyle countStyle = TextStyle(fontWeight: FontWeight.bold, fontSize: EternalFontSize.medium());
          ...
          headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
            return [
              SliverAppBar(
                ...
                leading: IconButton(icon: Icon(Icons.arrow_back), splashRadius: 20, onPressed: () => Navigator.of(context).pop()),
                actions: [
                  IconButton(onPressed: () {}, icon: Icon(Icons.search_rounded), splashRadius: 20),
                  IconButton(onPressed: () {}, icon: Icon(Icons.share_rounded), splashRadius: 20)
                ],
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text("♂", style: TextStyle(color: Colors.blue, fontSize: 15, fontWeight: FontWeight.bold))
                              ],
                            )
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            TextButton(
                              child: Row(
                                  children: [Text("${Random().nextInt(50)}", style: countStyle), SizedBox(width: 5), Text("关注", style: titleStyle)]),
                              onPressed: () {},
                            ),
                            TextButton(
                              child: Row(children: [
                  ...
                  title: Container(
                    ...
                    child: BackdropFilter(
                        ...
                        child: TabBar(
                          ...
                          unselectedLabelColor: EternalColors.selectColor,
                          tabs: [
                            Tab(text: "主页"),
                            Tab(text: "作品"),
                            Tab(text: "喜欢"),
